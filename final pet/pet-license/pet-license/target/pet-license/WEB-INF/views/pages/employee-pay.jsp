...
<div class="form-group "> 
							...
							<div class="form-group">
									...
									<l:choose>
									<l:when test="${pet.apptype == 'New' && pet.penalty=='No'}">
									...
									<div class="form-group required"> 
										...
										<l:when test="${pet.apptype == 'New' && pet.penalty=='Yes'}">
									...
									<div class="form-group required"> 
										...
										<div class="col-lg-8">
												<select name="purpose" class="form-control">
												<option value="Registration Fee">Registration Fee + Penalty(As You Are Applying After 31st March)</option>
												</select>									
												</div>
									</div>
									</l:when>
									
										<l:when test="${pet.apptype=='Renew' and pet.penalty=='No'}">
									<div class="form-group required"> 
									...
									<div class="form-group required"> 
										...
										<div class="col-lg-8">
											...
											<l:when test="${pet.apptype=='Renew' and pet.penalty=='Yes'}">
									<div class="form-group required"> 
									 		<label for="cname" class="control-label col-lg-4">Renewal Fee to Collect</label>
										<div class="col-lg-8">
												<input type="text" id="amount" name="amount" value="${pet.ulbBean.renew}">										
									...
									<div class="form-group required"> 
										...
										<div class="col-lg-8">
												<select name="purpose" class="form-control" style="pointer-events: none;">
												<option value="Renewal" style="pointer-events: none;">Renewal + Penalty</option>
												</select>									
												</div>
									</div>
									</l:when>
