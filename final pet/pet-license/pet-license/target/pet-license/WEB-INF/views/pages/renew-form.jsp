					...
					<div style="text-align:center">
							...
							<div class="panel-body">
								...
								<div class="form-group ">
										...
										<div class="col-lg-8">
										<input class="form-control" type="text"  name="oldnumber" id="oldnumber" value="${pet.registrationNumber}" readonly="readonly">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
											<input class="form-control" name="ageofdog" type="date"    id="ageofdog" onchange="getObject(this);" >
