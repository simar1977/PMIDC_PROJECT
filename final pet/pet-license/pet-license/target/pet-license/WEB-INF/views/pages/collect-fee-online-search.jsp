...
input::-webkit-inner-spin-button {
  ...
  margin: 0;
		...
		<div class="form-group ">
										...
										<div class="col-lg-8">
										<input class="form-control" type="number"  name="petId" id="petId" maxlength = "8" pattern="[0-9]+" title="only numbers are allowed">
										</div>
		</div>
		...
		<div class="form-group required ">
										...
										<div class="col-lg-8">
									<input class="form-control" type="number"  name="mobileNo" id="mobileNo" maxlength = "10" pattern="[0-9]+" title="only numbers are allowed">
										</div>
		</div>
