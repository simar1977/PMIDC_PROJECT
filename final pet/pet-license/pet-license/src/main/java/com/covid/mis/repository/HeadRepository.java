...
public interface HeadRepository extends CrudRepository<HeadBean, Integer>{
	...
	@Query("FROM HeadBean where headName like %:name% and ulbBean.ulbCode=:ulb and applicationStatus='Inspection Done.Pending for Approval.'")
	List<HeadBean> searchByNameForApproval(@Param("name")String name,@Param("ulb")int ulb);

	
	
	@Query("FROM HeadBean where fatherName like %:fathername% and ulbBean.ulbCode=:ulb and applicationStatus='Inspection Done.Pending for Approval.'")
	List<HeadBean> searchByFatherNameForApproval(@Param("fathername")String fathername,@Param("ulb")int ulb);

	@Query("FROM HeadBean where headName like %:name% and ulbBean.ulbCode=:ulb and localityBean.localityCode=:locality and applicationStatus='Inspection Done.Pending for Approval.'")
	List<HeadBean> searchByNameandLocalityForApproval(@Param("name")String name,@Param("locality") int locality,@Param("ulb")int ulb);

	
	
	@Query("FROM HeadBean where ulbBean.ulbCode=:ulb and localityBean.localityCode=:locality and applicationStatus='Inspection Done.Pending for Approval.'")
	List<HeadBean> searchByLocalityForApproval(@Param("locality")int locality,@Param("ulb")int ulb);
	
	@Query("FROM HeadBean where headName like %:name% and fatherName like %:fathername% and ulbBean.ulbCode=:ulb and applicationStatus='Inspection Done.Pending for Approval.'")
	...
	@Query("FROM HeadBean where fatherName like %:fathername% and ulbBean.ulbCode=:ulb and localityBean.localityCode=:locality and applicationStatus='Inspection Done.Pending for Approval.'")
	...
	@Query("FROM HeadBean where headName like %:name% and fatherName like %:fathername% and ulbBean.ulbCode=:ulb and localityBean.localityCode=:locality and applicationStatus='Inspection Done.Pending for Approval.'")
	...
	@Query("FROM HeadBean where districtBean.districtCode=:district and ulbBean.ulbCode=:ulb and applicationStatus='Inspection Done.Pending for Approval.'")
...
@Query("FROM HeadBean where headName like %:name% and ulbBean.ulbCode=:ulb and applicationStatus='Fee Received.Pending for Inspection.'")
List<HeadBean> searchByNameForInspection(@Param("name")String name,@Param("ulb")int ulb);

@Query("FROM HeadBean where fatherName like %:fathername% and ulbBean.ulbCode=:ulb and applicationStatus='Fee Received.Pending for Inspection.'")
List<HeadBean> searchByFatherNameForInspection(@Param("fathername")String fathername,@Param("ulb")int ulb);

@Query("FROM HeadBean where headName like %:name% and ulbBean.ulbCode=:ulb and localityBean.localityCode=:locality and applicationStatus='Fee Received.Pending for Inspection.'")
List<HeadBean> searchByNameandLocalityForInspection(@Param("name")String name,@Param("locality") int locality,@Param("ulb")int ulb);

@Query("FROM HeadBean where ulbBean.ulbCode=:ulb and localityBean.localityCode=:locality and applicationStatus='Fee Received.Pending for Inspection.'")
List<HeadBean> searchByLocalityForInspection(@Param("locality")int locality,@Param("ulb")int ulb);

@Query("FROM HeadBean where headName like %:name% and fatherName like %:fathername% and ulbBean.ulbCode=:ulb and applicationStatus='Fee Received.Pending for Inspection.'")
List<HeadBean> searchByNameandFatherNameForInspection(@Param("name")String name, @Param("fathername")String fathername,@Param("ulb")int ulb);

@Query("FROM HeadBean where fatherName like %:fathername% and ulbBean.ulbCode=:ulb and localityBean.localityCode=:locality and applicationStatus='Fee Received.Pending for Inspection.'")
List<HeadBean> searchByFatherNameandLocalityForInspection(@Param("fathername")String fathername,@Param("locality") int locality,@Param("ulb")int ulb);

@Query("FROM HeadBean where headName like %:name% and fatherName like %:fathername% and ulbBean.ulbCode=:ulb and localityBean.localityCode=:locality and applicationStatus='Fee Received.Pending for Inspection.'")
List<HeadBean> searchByAllParametersForInspection(@Param("name")String name, @Param("fathername")String fathername, @Param("locality")int locality,@Param("ulb")int ulb);

@Query("FROM HeadBean where districtBean.districtCode=:district and ulbBean.ulbCode=:ulb and applicationStatus='Fee Received.Pending for Inspection.'")
List<HeadBean> searchAllForInspection(@Param("district")int district,@Param("ulb")int ulb);


@Query("FROM HeadBean where ulbBean.ulbCode=:ulb and applicationStatus=:status order by tokenNo desc")
List<HeadBean> searchByULBApproved(@Param("ulb")int ulb,@Param("status")String status);


//----- aBHISHEK------------

@Query("FROM HeadBean where petId =:petId ")
List<HeadBean> searchBypetId(@Param("petId")Integer petId);


@Query("FROM HeadBean where tokenNo =:tokenNo and  districtBean.districtCode=:district ")
List<HeadBean> searchByregistrationNumber(@Param("tokenNo")Integer tokenNo,@Param("district")int district);




@Query("FROM HeadBean where headName = :name and  mobileNo =:mobileNo ")
List<HeadBean> searchol( @Param("name")String name,@Param("mobileNo")String mobileNo);


@Query("FROM HeadBean where headName = :name and  mobileNo =:mobileNo and petId =:petId ")
List<HeadBean> searcholl( @Param("name")String name,@Param("mobileNo")String mobileNo,@Param("petId")Integer petId);


@Query("FROM HeadBean where headName = :name and  mobileNo =:mobileNo and tokenNo =:tokenNo ")
List<HeadBean> searchsoll( @Param("name")String name,@Param("mobileNo")String mobileNo,@Param("tokenNo")Integer tokenNo);
