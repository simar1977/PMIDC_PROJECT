...
public interface HeadService {
	...
	List<HeadBean> searchByNameForInspection(String name,String ulb);

	List<HeadBean> searchByFatherNameForInspection(String fathername,String ulb);

	List<HeadBean> searchByNameandLocalityForInspection(String name, String locality,String ulb);

	List<HeadBean> searchByLocalityForInspection(String locality,String ulb);

	List<HeadBean> searchByNameandFatherNameForInspection(String name, String fathername,String ulb);

	List<HeadBean> searchByFatherNameandLocalityForInspection(String fathername, String locality,String ulb);

	List<HeadBean> searchByAllParametersForInspection(String name, String fathername, String locality,String ulb);

	List<HeadBean> searchAllForInspection(String district,String ulb);
	...
	List<HeadBean>  searchByULBApproved(int ulb , String status);
	...
	//-------------------Abhsihek Modification---------------------



	List<HeadBean> searchBypetId(Integer petId);


	List<HeadBean> searchol(String name, String mobileNo);

	



	List<HeadBean> searcholl(String name, String mobileNo, Integer petId);

	List<HeadBean> searchByregistrationNumber(Integer tokenNo, int district);


	

	List<HeadBean> searchsoll(String name, String mobileNo, Integer tokenNo);
