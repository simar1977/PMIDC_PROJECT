...
<section id="main-content">
	...
	<input  type="hidden"  name="apptype" id="apptype" value="${pet.apptype}">
	<input  type="hidden"  name="oldnumber" id="oldnumber" value="${pet.oldnumber}">
							...
							<div class="panel-body">
								...
								<div class="form-group required"> 
									...
									<div class="form-group required"> 
										...
										<div class="col-lg-8">
										<input type="file" id="idproofownerPPFront" name="idproofownerPPFront"><img id="idproofowner" name="idproofowner" width="100" height="100">										
										</div>
									</div>
									<div class="form-group required"> 
									 		<label for="cname" class="control-label col-lg-4">Id/Address proof of owner(Back Page)</label>
										<div class="col-lg-8">
										<input type="file" id="idproofownerPPBack" name="idproofownerPPBack"><img id="idproofownerBack" name="idproofownerBack" width="100" height="100">										
										</div>
									</div>
									...
									<div class="form-group required"> 
										...
										<div class="col-lg-8">
										<input type="file" id="fitnesscertificatePP" name="fitnesscertificatePP"><img id="fitnesscertificate" name="fitnesscertificate" width="100" height="100">										
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
										<input class="form-control" type="text"  name="nameofdog" id="nameofdog" value="${pet.nameofdog}">
										</div>
									</div>
									<div class="form-group required"> 
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
										<input class="form-control" type="text"  name="ageofdog" id="ageofdog" value="${pet.ageofdog}">
										</div>
									</div>							
									...
									<div class="form-group"> 
										...
										<div class="col-lg-8">
												<input type="file" id="defectPicPP" name="defectPicPP"><img id="defect" alt="No Pic uploaded" name="defect" width="100" height="100">										
												</div>
									</div>
									...
									<div class="form-group required"> 
										...
										<div class="col-lg-8">
												<input type="file" id="certificateFrontPicPP" name="certificateFrontPicPP"><img id="certificate" alt="No Pic uploaded" name="certificate" width="100" height="100">												
												</div>
									</div>
									<div class="form-group required"> 
										...
										<div class="col-lg-8">
												<input type="file" id="certificateBackPicPP" name="certificateBackPicPP"><img id="certificateBack" alt="No Pic uploaded" name="certificateBack" width="100" height="100">												
												</div>
									</div>
...
<!-- 									 	<div id="picsection" style="display:none"> -->
								...
								<!-- 	<div class="form-group"> 
									...
									<div class="form-group required"> 
										...
										<div class="col-lg-8">
												<textarea  id="comments" name="comments" rows="3" cols="60">${pet.comments}</textarea>						
												</div>
									</div>
