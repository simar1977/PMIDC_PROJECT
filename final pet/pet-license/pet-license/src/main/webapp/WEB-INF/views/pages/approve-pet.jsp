...
<section id="main-content">
			...
			<section class="panel" style="background-color: #999">
				<header class="panel-heading"> Approve Pet Registration For Pet Id  ${pet.petId}</header>
...
<div style="text-align:center">
									<span style="color: green; font-size: 16px; font-weight: 786;"
										...
										<input type="hidden" id="apptype" name="apptype" value="${pet.apptype}">
...
<div class="form-group "> 
                                       ...
                                       <span class="form-control" id='tfdistrict' name="ulbBean" >${pet.ulbBean.ulbName}</span>
									 		...
									 		<div class="form-group ">
										<label for="cname" class="control-label col-lg-4"> token</label>
										<div class="col-lg-8">
										<input class="form-control" type="text"  name="tokenNo" id="tokenNo" value="${pet.tokenNo}" readonly="readonly">
										</div>
									</div>
									<div class="form-group ">
...
<!-- 									 	<div id="picsection" style="display:none"> -->
			...
			function approvepet()
			{
    			...
    			window.location="/pet-license/approve-petsave?petId="+id+"&comments="+comments+"&tokenNo="+tokenNo;
			}
