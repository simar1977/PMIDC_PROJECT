			...
			<ul class="sidebar-menu" id="nav-accordion">
				...
				<c:choose>
					<c:when test="${val == 1}">
						...
						<li><a href="renew" style="cursor: pointer;"> <i
								class="fa fa-pencil-square-o"></i> <span>Renew Pet</span>
						</a></li>
					...
					<li id="menu-report"><a href="download-license"><i class="fa fa-table"
					aria-hidden="true"></i><span>Download Pet License</span><div class="clearfix"></div></a>
					</li>
					...
					href="#"> <i class="fa fa-key"></i> <span>Logout</span>
							...
							<c:when test="${val == 3}">
						<li id="menu-report"><a href="collect-fee-search"><i class="fa fa-table"
					aria-hidden="true"></i><span>Forward Pet License</span><div class="clearfix"></div></a>
					...
					<li id="menu-report"><a href="renew"><i class="fa fa-pencil-square-o"
					aria-hidden="true"></i><span>Renew Pet</span><div class="clearfix"></div></a>
					</li>
					...
					<li id="menu-report"><a href="download-license"><i class="fa fa-pencil-square-o"
					aria-hidden="true"></i><span>Download Pet License</span><div class="clearfix"></div></a>
					</li>
						</c:otherwise>
