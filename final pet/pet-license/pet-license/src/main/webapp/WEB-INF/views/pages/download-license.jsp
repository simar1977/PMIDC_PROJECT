...
input::-webkit-inner-spin-button {
  ...
  margin: 0;
		...
		<div class="form-group  required " id="dd"> 
									 		...
									 		<div class="col-lg-8">
                                       <select class="form-control" id='district' style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 16px;" name="districtBean" onchange="loadUlb()"></select>
									 		</div>
									 	</div>
