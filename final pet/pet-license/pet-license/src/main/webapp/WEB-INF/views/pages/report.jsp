...
<section id="main-content">
           ...
           <br><br>  <label for="curl"  style="text-align:center;">Select Locality</label> 
             ...
             <option value="Sent back with Objections">Sent back with Objections</option>
			 ...
			 <script type="text/javascript">
	    		...
	    		function selectPerson()
	    		{
	    		   ...
	    		   success: function(data, textStatus, xhr) {  
	    		    ...
	    		    if(item.tokenNo==0)
	    		    	htm=htm+ "<td style=\"font-size:14px\">Not Assigned</td>";
	    		    	else
		    		    	htm=htm+ "<td style=\"font-size:14px\">"+item.tokenNo+"</td>";

	    		    htm=htm+"<td style=\"font-size:14px\">"+item.headName+"</td>" +
		    		...
		    		if(item.applicationStatus=='In Renewal Process')
		    		...
		    		else if(item.applicationStatus!='Approved' && item.applicationStatus!='Rejected' )
		    			{htm=htm+"<td> <select id=\"actionDD"+item.petId+"\" name=\"actionDD"+item.petId+"\" onChange=\"getaction("+item.petId+")\"><option value=\"\">Select from below</option><option value=\"Edit Details\"><button style=\"color:teal; background-color: #FFFFC0; border: 3pt ridge lightgrey\">Edit Details</button></option>";
		    			}
	    		...
	    		else if(action=='Print Pet License')
	    		{
	    			...
	    			window.location="/pet-license/download-pet-license?petId="+id;
	    		}
    			...
    			window.location="/pet-license/renew?petId="+id;
    			}
	    		else if(action="renew-form")
    			{
