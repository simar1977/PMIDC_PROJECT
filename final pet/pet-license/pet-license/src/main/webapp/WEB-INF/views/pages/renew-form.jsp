...
<section id="main-content">
			...
			<section class="panel" style="background-color: #999">
				<header class="panel-heading">Renewal Details For License Number &nbsp;&nbsp;&nbsp; ${pet.registrationNumber} </header>
       ...
       font-size: 17px;
				...
				<div class="panel-body">
					<div class="position-center">
						<form method="POST" action="edit-head-datas" class="cmxform form-horizontal" name="petBean" id="renewForm" onsubmit="return renewform()" enctype="multipart/form-data">
					...
					<input type="hidden" id="fee" name="fee" value="${pet.fee}">					
					 ...
					 <input type="hidden" id="registrationNumber" name="registrationNumber" value="${pet.registrationNumber}"/>
					 <input type="hidden" id="tokenNo" name="tokenNo" value="${pet.tokenNo}"/>
					
					<div style="text-align:center">
									<span style="color: green; font-size: 17px; font-weight: 786;"
							...
							<div class="panel-body">
								...
								<div class="form-group "> 
									 		...
									 		<div class="col-lg-8">
                                       <select class="form-control" id='tfdistrict'  name="districtBean"  onchange="loadUlb()" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; pointer-events: none;"></select>
									 		</div>
									 	</div>
									 	...
									 	<div class="form-group"> 
									 		...
									 		<div class="col-lg-8">
                                       <select class="form-control" id='tfulb' name="ulbBean"  onchange="loadLocality()" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; pointer-events: none;"></select>
									 		</div>
									 	</div>
									<div class="form-group ">
										<label for="cname" class="control-label col-lg-4">Name Of the applicant</label>
										<div class="col-lg-8">
										<input class="form-control" type="text" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; "  name="headName" id="tfname" value="${pet.headName}" readonly="readonly">
										</div>
									</div>
									
								<div class="form-group ">
										<label for="cname" class="control-label col-lg-4">Old License Number </label>
										<div class="col-lg-8">
										<input class="form-control" type="text"  name="oldnumber" id="oldnumber" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; " value="${pet.registrationNumber}" readonly="readonly">
										</div>
									</div>
									
									<div class="form-group ">
										<label for="cname" class="control-label col-lg-4"> Token No / Registration No </label>
										<div class="col-lg-8">
										<input class="form-control" type="text" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; "  name="tokenNo" id="tokenNo" value="${pet.tokenNo}" readonly="readonly">
										</div>
									</div>
									...
									<div class="form-group ">
										...
										<div class="col-lg-8">
										<input class="form-control" type="text" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; "  name="fatherName" id="tffname" value="${pet.fatherName}" readonly="readonly">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
										<input class="form-control" type="text"  style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; " name="houseNo" id="tfhouse" value="${pet.houseNo}" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										<label for="cname" class="control-label col-lg-4">Ward No.</label>
										<div class="col-lg-8">
										<input class="form-control" type="text"  name="wardNo" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; " id="tfward" value="${pet.wardNo}" readonly="readonly">
										</div>
									</div>
    							...
    							If You Changed Your Address?
									...
									<div class="form-group ">
										...
										<div class="col-lg-8">
										<input class="form-control" type="text"  name="perAddress" id="tfpaddress" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; " value="${pet.perAddress}" readonly="readonly">
										</div>
									</div>
									...
									<div class="form-group ">
										...
										<div class="col-lg-8">
										<input class="form-control" type="text"  name="resAddress" id="tfraddress" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; " value="${pet.resAddress}" readonly="readonly">
										</div>
									</div>
									<div class="form-group ">
										<label for="cname" class="control-label col-lg-4">Mobile Number</label>
										<div class="col-lg-8">
										<input class="form-control" type="text"  name="mobileNo" id="tfmobileno" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; " value="${pet.mobileNo}" readonly="readonly">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
										<input class="form-control" type="text"  name="email" id="tfemail" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; " value="${pet.email}" readonly="readonly">
										</div>
									</div>
									...
									<div class="form-group"> 
									 		...
									 		<div class="col-lg-8">
                                       <select class="form-control" id='tfcategory' style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; pointer-events: none;" name="categoryBean" onchange="loadType()" style="pointer-events: none;">
									...
									<div class="form-group "> 
									 		...
									 		<div class="col-lg-8">
                                       <select class="form-control" id='tftype' style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; pointer-events: none;" name="typeBean" style="pointer-events: none;">
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
										<input class="form-control" type="text"  readonly="readonly" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; " name="nameofdog" id="nameofdog" value="${pet.nameofdog}">
										</div>
									</div>
									<div class="form-group required"> 
									 		<label for="curl" class="control-label col-lg-4">Gender of Animal</label> 
									 		<div class="col-lg-8">
                                       <select class="form-control" id='tgender' style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; pointer-events: none;" name="doggender" style="pointer-events: none;">
									...
									<div class="form-group "> 
									 		...
									 		<div class="col-lg-8">
                                       <select class="form-control" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; pointer-events: none;" id='tvacc' name="vacc" >
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
										<input class="form-control" type="text" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; "  name="petmark" id="petmark" value="${pet.petmark}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
											<input class="form-control" name="ageofdog" type="date"  style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; "  id="ageofdog" onchange="getObject(this);" >
											
<label class="a1" id="lbltipAddedComment"></label><br>
											
											 <label for="cname">(Old Date of Birth of Pet)-> ${pet.ageofdog}    </label>
									...
									<div class="form-group"> 
									 		...
									 		<div class="col-lg-8">
                                       <select class="form-control" style="border:1px solid red; font-family:Times New Roman, Serif;   font-size: 17px; pointer-events: none;" id='tfcolour' name="colourBean" style="pointer-events: none;">
...
<!-- 									 	<div id="picsection" style="display:none"> -->
                                ...
                                <button class="btn btn-danger" type="reset" id="resetFormDataBtn"><a href="renew">Cancel</a></button>
                                </div>
								</div>
							</div>
						</form>
...
<script type="text/javascript">
    function EnableDisableTextBox(chkPassport) {
        ...
        if (!tfraddress.readonly) {
        	tfraddress.focus();
        	document.getElementById('tfraddress').removeAttribute('readonly');
        ...
        if (tfraddress.readonly) {
        	tfraddress.focus();
        	document.getElementById('tfraddress').setAttribute("readonly", "readonly");
