...
<section id="main-content">
		<section class="wrapper">
			<section class="panel" style="background-color: #999">
				<head>
				<header class="panel-heading"> Collect Renewal  Fee for Token No ${pet.tokenNo}</header>
				...
				<label for="curl" class="control-label col-lg-4">District</label> 
                                       ...
                                       <span class="form-control" id='tfdistrict' name="districtBean" >${pet.districtBean.districtName}</span>
									 	...
									 	<div class="form-group "> 
									 		...
									 		<div class="col-lg-8">
                                       <span class="form-control" id='tfdistrictname' name="ulbBean" >${pet.ulbBean.ulbName}</span>
									 		</div>
									 	</div>
								...
								<div class="form-group ">
									...
									<div class="form-group"> 
										...
										<div class="col-lg-8">
										<img id="idproofownerPP" name="idproofownerPP" alt="No Pic uploaded" width="200" height="200">										
										</div>
									</div>
									<div class="form-group "> 
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
										<span class="form-control" name="nameofdog" id="nameofdog">${pet.nameofdog}</span>
										</div>
									</div>
									...
									<div class="form-group "> 
									 		...
									 		<div class="col-lg-8">
                                       <span class="form-control" id='tgender' name="doggender">${pet.doggender}</span>
									 	  
										</div>
									</div>
										<div class="form-group "> 
									 		<label for="curl" class="control-label col-lg-4">Age of Animal</label> 
									 		<div class="col-lg-8">
                                       <span class="form-control" id='ageofdog' name="ageofdog">${pet.ageofdog}</span>
									...
									<div class="form-group "> 
										...
										<div class="col-lg-8">
												<img id="defectPicPP" name="defectPicPP" alt="No Pic Uploaded" width="200" height="200">										
												</div>
									</div>
									<div class="form-group "> 
									 		<label for="curl" class="control-label col-lg-4">Vaccination?</label> 
									 		<div class="col-lg-8">
                                       <span class="form-control" id='tvacc' name="vacc">${pet.vacc}</span>
										</div>
									</div>
									...
									<div class="form-group "> 
										...
										<div class="col-lg-8">
												<span><img id="certificatePicPP" alt="No Pic Uploaded"  width="200" height="200"></span>									
												</div>
									</div>
...
<!-- 									 	<div id="picsection" style="display:none"> -->
										...
										<div class="col-lg-8">
												<img id="frontPicPP" name="frontPicPP" width="200" height="150">										
												</div>
									</div>
									...
									<div class="form-group "> 
										...
										<div class="col-lg-8">
												<img id="ownerPicPP" name="ownerPicPP" width="200" height="150">										
												</div>
									</div>
									<l:choose>
									<l:when test="${pet.fee == 'No' }">
									<div class="form-group required"> 
									 		<label for="cname" class="control-label col-lg-4">Renewal Fee Is</label>
										<div class="col-lg-8">
									...
									<l:otherwise>
									<div> 
									 	<span style="text-align:center;color: Red; font-size: 24px; font-weight: 786;"> Renewal  Fee had already been collected.</span>
									</div>
