...
<section id="main-content">
			...
			<section class="panel" style="background-color: #999">
				<header class="panel-heading"> View Details for Pet Id ${pet.petId}</header>
...
<div class="form-group "> 
								...
								<div class="form-group ">
									...
									<div class="form-group ">
										<label for="cname" class="control-label col-lg-4">Residential Address</label>
										<div class="col-lg-8">
										<span class="form-control" id="tfraddress">${pet.resAddress}</span>
										</div>
										<br>
										<div></div>
									</div>
									...
									<div class="form-group ">
										...
										<div class="col-lg-8">
										<span class="form-control"  name="houseNo" id="tfhouse">${pet.houseNo}</span>
										</div>
									</div>
									<div class="form-group ">
									...
									<div class="form-group "> 
									 		<label for="curl" class="control-label col-lg-4">Locality/Area/Mohalla/Sector</label> 
									 		<div class="col-lg-8">
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
										<span class="form-control" type="text"  name="ageofdog" id="ageofdog">${daydiff}</span>
										</div>
									</div>	
									...
									<div class="form-group "> 
										...
										<div class="col-lg-8">
												<span><img id="certificateFrontPicPP" alt="No Pic Uploaded"  width="100" height="100"></span>									
												</div>
												<div class="form-group "> 
										...
										<div class="col-lg-8">
												<span><img id="certificateBackPicPP" alt="No Pic Uploaded"  width="100" height="100"></span>									
												</div>
									</div>
...
<!-- 									 	<div id="picsection" style="display:none"> -->
									...
									<div class="form-group "> 
									 		<label for="curl" class="control-label col-lg-4">Comments</label> 
									 		<div class="col-lg-8">
									 		<span class="form-control" id='tfcomments' name="comments">${pet.comments}</span>
                                ...
                                <button class="btn btn-danger" type="reset" id="resetFormDataBtn" onclick="homePage()">Cancel</button>
                                </div>
								</div>
			...
			$(document).ready(function(){
				...
				$('#defectPicPP').attr('src',"/pet-license/getAttachedDocuments/DEFECT?pet_id="+petid);
	       		$('#certificateFrontPicPP').attr('src',"/pet-license/getAttachedDocuments/CERTIFICATE?pet_id="+petid);
	       		$('#certificateBackPicPP').attr('src',"/pet-license/getAttachedDocuments/CERTIFICATEBACK?pet_id="+petid);
			 ...
			 function homePage()
			   {
				  	 window.location="/pet-license/admin-login";
			   }
