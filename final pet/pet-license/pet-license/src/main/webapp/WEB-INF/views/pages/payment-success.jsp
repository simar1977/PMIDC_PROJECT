...
<section id="main-content">
			...
			<section class="panel" style="background-color: #fff">
				<header class="panel-heading"><p style="color:green"> 
				<div id="myDiv">
				<p>${fee.purpose} has been collected successfully.</p></div></header>
...
<p style="text-align:center;font-size:20px">Pet License Receipt</p>
</h3>
</div>
</td>
<td width=10%><br></td>
...
<tr style="border:1px solid black;">
<td style="width=30%">&nbsp;&nbsp;&nbsp;</td>
<th>Old Registarion Number</th>
<td id="lvdob">${pet.oldnumber}</td>
</tr>
<tr style="border:1px solid black;">
<td style="width=30%">&nbsp;&nbsp;&nbsp;</td>
<th>Pet Id</th>
...
<td style="width=30%">&nbsp;&nbsp;&nbsp;</td>
<th>Amount</th>
<td id="lvmobileno">Rs. ${fee.amount}</td>
<td><br></td>
</tr>
...
<td id="lvmobileno">Payment Successful</td>
<td><br></td>
</tr>
