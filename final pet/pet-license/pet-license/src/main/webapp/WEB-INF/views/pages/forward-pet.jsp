...
<section id="main-content">
			...
			<section class="panel" style="background-color: #999">
				<header class="panel-heading"> Forward Pet Application of ${pet.petId} </header>
...
<div class="form-group "> 
                                       ...
                                       <span class="form-control" id='tfdistrict' name="ulbBean" >${pet.ulbBean.ulbName}</span>
										...
										<div class="col-lg-8">
										<span class="form-control" type="text"  name="headName" id="tfname">${pet.tokenNo}</span>
										</div>
									</div>
									<div class="form-group ">
								...
								<div class="form-group ">
									...
									<div class="form-group"> 
									 		<label for="cname" class="control-label col-lg-4">Id/Address proof of owner(Front)</label>
										<div class="col-lg-8">
										<img id="idproofowner" name="idproofowner" width="100" height="100">										
										</div>
									</div>
										<div class="form-group"> 
									 		<label for="cname" class="control-label col-lg-4">Id/Address proof of owner(Back)</label>
										<div class="col-lg-8">
									...
									<div class="form-group "> 
									 		<label for="cname" class="control-label col-lg-4">Has the animal been certified by the veterinary Doctor to be free from infectious diseases?(Front)</label>
										<div class="col-lg-8">
												<span><img id="certificatePicPP" alt="No Pic Uploaded"  width="100" height="100"></span>									
												</div>
									</div>
										<div class="form-group "> 
									 		<label for="cname" class="control-label col-lg-4">Has the animal been certified by the veterinary Doctor to be free from infectious diseases?(Back)</label>
										<div class="col-lg-8">
												<span><img id="certificatePicPPBack" alt="No Pic Uploaded"  width="100" height="100"></span>									
												</div>
									</div>
...
<!-- 									 	<div id="picsection" style="display:none"> -->
									...
									<div class="form-group">
										<label for="cname" class="control-label col-lg-4">Application Type</label>
										<div class="col-lg-4">
										<span class="form-control" type="text"  name="apptype" id="apptype">${pet.apptype}</span>
										</div>
									</div>
									...
									<div class="form-group required "> 
									 ...
									 <input type="button" class="btn btn-info" id="forward" onclick="forwardpet();" value="Send Forward for Approval">
									  <input type="button" class="btn btn-info" id="back" onclick="sendbackpet();" value="Send Back to Clerk">									 
			...
			$(document).ready(function(){
				...
				$('#defectPicPP').attr('src',"/pet-license/getAttachedDocuments/DEFECT?pet_id="+petid);
	       		...
	       		$('#certificatePicPPBack').attr('src',"/pet-license/getAttachedDocuments/CERTIFICATEBACK?pet_id="+petid);
				...
				if($('#testingErrorMsg').val()  !="")
					{
					debugger;
					document.getElementById("forward").display = none;
			...
			function forwardpet()
			{
    			...
    			window.location="/pet-license/forward-petsave?petId="+id+"&comments="+comments;
			}
			...
			function rejectpet()
			{
    			...
    			window.location="/pet-license/forward-pet?petId="+id+"&comments="+comments;
			}
