...
<!-- 									 	<div id="picsection" style="display:none"> -->
									...
									<div class="form-group required"> 
									 		<label for="cname" class="control-label col-lg-4">Registration Fee to be Paid</label>
										<div class="col-lg-8">
												<input type="text" readonly="readonly" id="payment_field" value="${pet.ulbBean.regFee}">										
												</div>
									</div>
								...
								<l:otherwise>
									<div> 
									 	<span style="text-align:right; color: Red; font-size: 20px; font-weight: 786;"> Registration Fee has already been collected.</span>
									</div>
