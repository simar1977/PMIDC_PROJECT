...
//	  var defectPicPP = $('#defectPicPP').val();
	  var certificatePicPP = $('#certificatePicPP').val();
	  var fronttPicPP = $('#frontPicPP').val();
	  ...
	  if(district=="")
		...
		{
		  alert('Please Select Fee paid or not!');
		$('#tffee').focus();
		return false
		}
		else if(mobileNo=="")
		...
		else if(certificatePicPP=="")
		{
		  alert('Please attach Files!');
		$('#certificatePicPP').focus();
		return false
		}
		else if(frontPicPP=="")
		{
