...
<body>
	...
	String access_code = "AVZY93HG58BJ92YZJB"; //Put access code here
	String enc_key = "341E1552459FC24752F23B0C14140280"; 
...
<!-- 		<input type="hidden" name="order_id" id="order_id" value="AA"> -->
