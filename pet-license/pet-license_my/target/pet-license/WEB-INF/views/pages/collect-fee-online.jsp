			...
			<section class="panel" style="background-color: #999">
				...
				<div class="panel-body">
					<div class="position-center">
						<form method="POST" action="ccavRequestHandler" class="cmxform form-horizontal" name="feeBean" id="collectfeeform" onsubmit="return validateFeeForm()">
...
<!-- 									 	<div id="picsection" style="display:none"> -->
									...
									<div class="form-group required"> 
										...
										<div class="col-lg-8">
												<input type="text" readonly=true value="${pet.ulbBean.regFee}">										
												</div>
									</div>
