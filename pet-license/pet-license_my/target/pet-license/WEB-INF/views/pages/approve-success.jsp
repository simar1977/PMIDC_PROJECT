...
<section id="main-content">
			...
			<section class="panel" style="background-color: #fff">
				<header class="panel-heading"><p style="color:green"> Pet Registration Application has been approved successfully .</p></header>
...
<p style="text-align:center">Pet Registration Certificate</p>
</h3>
</div>
</td>
</tr></table>
